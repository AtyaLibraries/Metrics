...
PACKAGE_PROJECT="./src/Metrics/Metrics.csproj"
TEST_PROJECT="./tests/Metrics.UnitTests/Metrics.UnitTests.csproj"
SAMPLE_PROJECT="./samples/Metrics.Samples.Console/Metrics.Samples.Console.csproj"
BENCHMARK_PROJECT="./benchmarks/Metrics.Benchmarks/Metrics.Benchmarks.csproj"
